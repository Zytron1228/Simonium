...
class SimonCellType : AppCompatImageView {
    ...
    fun setOn() {
        setImageDrawable(resources.getDrawable(litImage)) //getDrawable() may be gone soon, replace when needed
        refreshDrawableState()
    }

    fun setOff() {
        state = OFF
        setImageDrawable(resources.getDrawable(offImage)) //getDrawable() may be gone soon, replace when needed
        refreshDrawableState()
    }
